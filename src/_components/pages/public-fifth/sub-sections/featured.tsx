 ...
 */
export const FifthSectionFeaturedCategory = ({
  category,
  ref,
  id,
}: FifthSectionFeaturedCategoryProps) => {
  ...
  return (
    <section
      className="mt-10 md:mt-16 lg:mt-20 px-4 sm:px-6 md:px-8 max-w-screen-2xl mx-auto mb-10"
      ref={ref}
      id={id}
    >
