    ...
    <div className="max-w-3xl mx-auto bg-gray-50 p-6 shadow-sm">
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-4 flex-wrap">
          ...
          {category && <span className="text-primaryGreen font-medium">{category}</span>}
          {date && (
            <div className="flex items-center gap-2">
              <div className="bg-primaryGreen rounded-full p-1.5 text-white flex items-center justify-center">
